# Django settings for gladson project.
...
STATIC_ROOT = os.path.abspath(os.path.join(CURRENT_DIR, 'sitestatic'))
...
SECRET_KEY = '3fyg#h4a)d9*8rog85c%i2-gu5h37yd61^!zt)y8ke+$j7*e_q'
